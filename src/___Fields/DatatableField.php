...
namespace Saguajardo\Datatable\Fields;

use Illuminate\Database\Eloquent\Collection;
use Saguajardo\Datatable\Datatable;
use Saguajardo\Datatable\DatatableHelper;

/**
 * Class DatatableField
 *
 * @package Saguajardo\Datatable\Fields
 */
abstract class DatatableField
{
    /**
     * Name of the field
     *
    ...
    public function __construct($name, $type, Form $parent, array $options = [])
    {
        ...
        $this->type = $type;
        $this->parent = $parent;
        $this->datatableHelper = $this->parent->getDatatableHelper();
        $this->setTemplate();
    ...
    {
        return $this->datatableHelper->transformToDotSyntax($key);
    }
    ...
    {
        return [
            'wrapper' => ['class' => $this->datatableHelper->getConfig('defaults.wrapper_class')],
            ]],
            'value' => null,
            'default_value' => null,
            'label' => null,
            'is_child' => false,
            'label_attr' => ['class' => $this->datatableHelper->getConfig('defaults.label_class')],
            'errors' => ['class' => $this->datatableHelper->getConfig('defaults.error_class')]
        ];
    }
    ...
    {
        $this->template = $this->datatableHelper->getConfig($this->getTemplate(), $this->getTemplate());
    }
    ...
    {
        $this->options = $this->datatableHelper->mergeOptions($this->allDefaults(), $this->getDefaults());
        $this->options = $this->prepareOptions($options);
        $this->setupLabel();
    }
    ...
    protected function setupLabel()
    {
        ...
        $this->setOption('label', $this->datatableHelper->formatLabel($label));
    }
